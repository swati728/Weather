...
import com.example.weatherapp.di.AppModule_ProvideJsonFactory;
...
import com.example.weatherapp.di.AppModule_ProvideWeatherApiServiceFactory;
import com.example.weatherapp.di.AppModule_ProvideWeatherDaoFactory;
import com.example.weatherapp.di.AppModule_ProvideWeatherDatabaseFactory;
import com.example.weatherapp.presentation.viewmodel.WeatherViewModel;
import com.example.weatherapp.presentation.viewmodel.WeatherViewModel_HiltModules;
...
public final class DaggerWeatherApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends WeatherApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_weatherapp_presentation_viewmodel_WeatherViewModel, WeatherViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_weatherapp_presentation_viewmodel_WeatherViewModel = "com.example.weatherapp.presentation.viewmodel.WeatherViewModel";

      @KeepFieldType
      WeatherViewModel com_example_weatherapp_presentation_viewmodel_WeatherViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends WeatherApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_weatherapp_presentation_viewmodel_WeatherViewModel, ((Provider) weatherViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.weatherapp.presentation.viewmodel.WeatherViewModel 
  ...
  private static final class SingletonCImpl extends WeatherApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideWeatherApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<WeatherApiService>(singletonCImpl, 1));
      this.provideWeatherDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<WeatherDatabase>(singletonCImpl, 6));
      this.provideWeatherDaoProvider = DoubleCheck.provider(new SwitchingProvider<WeatherDao>(singletonCImpl, 5));
      this.weatherRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<WeatherRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.weatherapp.data.repository.WeatherRepository 
          return (T) new WeatherRepository(singletonCImpl.provideWeatherApiServiceProvider.get(), singletonCImpl.provideWeatherDaoProvider.get());

          case 1: // com.example.weatherapp.data.remote.WeatherApiService 
          ...
          case 5: // com.example.weatherapp.data.local.WeatherDao 
          return (T) AppModule_ProvideWeatherDaoFactory.provideWeatherDao(singletonCImpl.provideWeatherDatabaseProvider.get());

          case 6: // com.example.weatherapp.data.local.WeatherDatabase 
